...
class Team extends Controller {
    ...
    public function create() {
        ...
        $roles = $this->roles->allTeamRoles([17]);
    ...
    public function store() {
        ...
        if (!runtimeTeamCreateAdminPermissions(request('role_id')) || request('role_id') == 17) {
            abort(403);
        }
    ...
    public function update($id) {
        ...
        //check permissions
        if (!runtimeTeamPermissionEdit($user)  || request('role_id') == 17) {
            abort(403);
        }
    ...
    private function pageSettings($section = '', $data = []) {
        ...
        $page = [
            ...
            'dynamic_search_url' => 'technician/search?source=' . request('source') . '&action=search',
            'add_button_classes' => '',
