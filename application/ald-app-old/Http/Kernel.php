...
class Kernel extends HttpKernel {
    ...
    protected $routeMiddleware = [
        ...
        //[growcrm] - [team]
        'managerMiddlewareIndex' => \App\Http\Middleware\Managers\Index::class,
        'managerMiddlewareCreate' => \App\Http\Middleware\Managers\Create::class,
        'managerMiddlewareEdit' => \App\Http\Middleware\Managers\Edit::class,
