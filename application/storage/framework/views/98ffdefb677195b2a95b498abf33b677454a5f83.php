...
<div class="filter-block">
    ...
    <div class="fields">
        <div class="row">
            <div class="col-md-12">
                <select class="select2-basic form-control form-control-sm" data-allow-clear="true"
                    id="filter_<?php echo e($field->customfields_name); ?>" name="filter_<?php echo e($field->customfields_name); ?>">
                    <option value=""></option>
...
<?php endif; ?>
<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php /**PATH C:\laragon\www\cms\application\resources\views/misc/customfields-filters.blade.php ENDPATH**/ ?>