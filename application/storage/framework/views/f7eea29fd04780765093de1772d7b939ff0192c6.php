                ...
                <thead>
                    <tr>
                        <th class="team_col_first_name"><a class="js-ajax-ux-request js-list-sorting"
                                ...
                                data-url="<?php echo e(urlResource('/manager?action=sort&orderby=first_name&sortorder=asc')); ?>"><?php echo e(cleanLang(__('lang.first_name'))); ?><span
                                    class="sorting-icons"><i class="ti-arrows-vertical"></i></span></a></th>
                        <th class="team_col_position"><a class="js-ajax-ux-request js-list-sorting" id="sort_position"
                                href="javascript:void(0)"
                                data-url="<?php echo e(urlResource('/manager?action=sort&orderby=position&sortorder=asc')); ?>"><?php echo e(cleanLang(__('lang.position'))); ?><span
                        ...
                        <th class="team_col_role"><a class="js-ajax-ux-request js-list-sorting" id="sort_role_id"
                                href="javascript:void(0)"
                                data-url="<?php echo e(urlResource('/manager?action=sort&orderby=role_id&sortorder=asc')); ?>"><?php echo e(cleanLang(__('lang.role'))); ?><span
                                    class="sorting-icons"><i class="ti-arrows-vertical"></i></span>
                        </th>
                        <?php endif; ?>
                        <th class="team_col_email"><a class="js-ajax-ux-request js-list-sorting" id="sort_email"
                                href="javascript:void(0)"
                                data-url="<?php echo e(urlResource('/manager?action=sort&orderby=email&sortorder=asc')); ?>"><?php echo e(cleanLang(__('lang.email'))); ?><span
                                    class="sorting-icons"><i class="ti-arrows-vertical"></i></span>
                        </th>
                        <th class="team_col_phone"><a class="js-ajax-ux-request js-list-sorting" id="sort_phone"
                                href="javascript:void(0)"
                                data-url="<?php echo e(urlResource('/manager?action=sort&orderby=phone&sortorder=asc')); ?>"><?php echo e(cleanLang(__('lang.phone'))); ?><span
                                    class="sorting-icons"><i class="ti-arrows-vertical"></i></span>
                        </th>
                        <?php if(config('visibility.action_super_user')): ?>
                        <th class="team_col_last_active"><a class="js-ajax-ux-request js-list-sorting"
                                id="sort_last_seen" href="javascript:void(0)"
                                data-url="<?php echo e(urlResource('/manager?action=sort&orderby=last_seen&sortorder=asc')); ?>"><?php echo e(cleanLang(__('lang.last_seen'))); ?><span
...
</div><?php /**PATH C:\laragon\www\cms\application\resources\views/pages/managers/components/table/table.blade.php ENDPATH**/ ?>