...
class Project extends Model {
    ...
    public function lead() {
        return $this->belongsTo('App\Models\Lead', 'project_created_from_leadid', 'lead_id');
    }
    ...
    /**
     * The Client's side project manager for the Porject.
     */
    public function client_project_manager() {
        return $this->belongsTo('App\Models\User', 'project_custom_field_51');
    }
    /**
     * The Client's side site manager for the Porject.
     */
    public function client_site_manager() {
        return $this->belongsTo('App\Models\User', 'project_custom_field_52');
    }
    /**
     * relatioship business rules:
 ...
 /**
     * The CAD Technician for the Porject.
     */
    public function cad_technician() {
        return $this->belongsTo('App\Models\User', 'project_custom_field_53');
    }
}
