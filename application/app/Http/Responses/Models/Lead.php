...
class Lead extends Model {
    ...
    /**
     * The Client that generate the Lead.
     */
    public function client() {
        return $this->belongsTo('App\Models\Client', 'lead_converted_clientid');
    }
    /**
     * The Client's side project manager for the Lead.
     */
    public function client_project_manager() {
        return $this->belongsTo('App\Models\User', 'lead_custom_field_111');
    }
    /**
     * The Client's side site manager for the Lead.
     */
    public function client_site_manager() {
        return $this->belongsTo('App\Models\User', 'lead_custom_field_112');
    }
    /**
     * relatioship business rules:
