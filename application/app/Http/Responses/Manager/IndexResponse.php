...
class IndexResponse implements Responsable {
    ...
    public function toResponse($request) {
        ...
        if (request('source') == 'ext' || request('action') == 'search' || request()->ajax()) {
            ...
            case 'load':
                $template = 'pages/managers/components/table/ajax';
            ...
            case 'search':
                $template = 'pages/managers/components/table/table';
            ...
            default:
                $template = 'pages/managers/tabswrapper';
            ...
            return view('pages/managers/wrapper', compact('page', 'users'))->render();
        }
