...
class CadHistoryListResponse implements Responsable {
    ...
    public function toResponse($request) {
        ...
        if (request('source') == 'ext' || request('action') == 'search' || request()->ajax()) {
            ...
            case 'load':
                $template = 'pages/projects/views/list/table/cad_history_ajax';
                $dom_container = '#projects-td-container';
                $dom_action = 'append';
                break;
            ...
            case 'search':
                $template = 'pages/projects/views/list/table/cad_history_table';
            ...
            default:
                $template = 'pages/projects/views/list/tabswrapper';
            ...
            $html = view($template, compact('page','show_history', 'projects', 'stats', 'categories', 'tags'))->render();
            ...
            return view('pages/projects/views/list/cad_wrapper', compact('page','show_history', 'projects', 'stats', 'categories', 'tags'))->render();
        }
