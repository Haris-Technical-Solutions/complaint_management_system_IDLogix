...
class CadListResponse implements Responsable {
    ...
    public function toResponse($request) {
        ...
        if (request('source') == 'ext' || request('action') == 'search' || request()->ajax()) {
            ...
            case 'load':
                $template = 'pages/projects/views/list/table/cad_ajax';
            ...
            case 'search':
                $template = 'pages/projects/views/list/table/cad_table';
            ...
            return view('pages/projects/views/list/cad_wrapper', compact('page', 'projects', 'stats', 'categories', 'tags'))->render();
        }
