...
class ShowCalanderResponse implements Responsable {
    ...
    public function toResponse($request) {
        ...
        if (request('source') == 'ext' || request('action') == 'search' || request()->ajax()) {
            ...
            case 'search':
                $template = 'pages/calanders/components/table/table';
                $dom_container = '#tasks-componente-view-wrapper';
                $dom_action = 'replace-with';
                break;

            //tasklate and dom - for ajax initial loading
            default:
                $template = 'pages/calanders/tabswrapper';
            ...
            $html = view($template, compact('page','data','worklog','cal_start_date','cal_end_date','tasks','parent_tasks','child_tasks', 'stats', 'tags', 'milestones', 'statuses'))->render();
            ...
            $template = 'pages/calanders/wrapper';
            //standard view
               $data = $caltasks;
            ...
            return view($template, compact('page', 'tasks','cal_start_date','cal_end_date','parent_tasks','child_tasks','worklog','data','stats', 'tags', 'milestones', 'statuses'))->render();
        }
    }
}
