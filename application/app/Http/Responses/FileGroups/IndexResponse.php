...
class IndexResponse implements Responsable {
    ...
    public function toResponse($request) {
        ...
        if (request('source') == 'ext' || request('action') == 'search' || request()->ajax()) {
            ...
            case 'load':
                $template = 'pages/filegroups/components/table/ajax';
            ...
            case 'search':
                $template = 'pages/filegroups/components/table/table';
            ...
            default:
                $template = 'pages/filegroups/tabswrapper';
            ...
            if ($filegroups->currentPage() < $filegroups->lastPage()) {
                $url = loadMoreButtonUrl($filegroups->currentPage() + 1, request('source'));
            ...
            $html = view($template, compact('page', 'filegroups','fileresource_type'))->render();
            ...
            $page['url'] = loadMoreButtonUrl($filegroups->currentPage() + 1, request('source'));
            $page['loading_target'] = 'files-td-container';
            $page['visibility_show_load_more'] = ($filegroups->currentPage() < $filegroups->lastPage()) ? true : false;
            return view('pages/filegroups/wrapper', compact('page', 'filegroups'))->render();
        }
