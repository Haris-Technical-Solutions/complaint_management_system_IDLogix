...
class Authenticate extends Controller {
    ...
    //     if ($user->is_client) {
    //         $client = \App\Models\Client::where('client_id', $user->clientid)->first();
    //         if ($client && $client->client_status != 'active') {
    //             abort(409, __('lang.account_has_been_suspended'));
    //         }
    //     }

    //     // Check if client login is disabled
    //     if ($user->is_client && config('system.settings_clients_app_login') != 'enabled') {
    //         abort(409, __('lang.clients_disabled_login_error'));
    //     }
