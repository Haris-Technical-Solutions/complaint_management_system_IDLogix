 ...
 *----------------------------------------------------------------------------------*/
 ...
 use App\Http\Responses\Manager\CreateResponse;
 use App\Http\Responses\Manager\EditResponse;
 use App\Http\Responses\Manager\IndexResponse;
 use App\Http\Responses\Manager\StoreResponse;
 use App\Http\Responses\Manager\UpdateResponse;
...
class Managers extends Controller {
    ...
    public function __construct(
        ...
        $this->middleware('managersMiddlewareIndex')->only([
            'index',
            'update',
            'store',
        ]);

        $this->middleware('managersMiddlewareCreate')->only([
            'create',
            'store',
        ]);

        $this->middleware('managersMiddlewareEdit')->only([
            'edit',
            'update',
            'destroy',
        ]);
    ...
    public function index() {
        ...
        //reponse payload
        $payload = [
            'page' => $this->pageSettings('manager'),
            'users' => $users,
        ];
    ...
    private function pageSettings($section = '', $data = []) {
        ...
        $page = [
            ...
            'heading' => __('lang.manager'),

            'page' => 'team',
            'no_results_message' => __('lang.no_results_found'),
            'mainmenu_settings' => 'active',
            'submenu_team' => 'active',
            'sidepanel_id' => 'sidepanel-filter-manager',
            'dynamic_search_url' => 'manager/search?source=' . request('source') . '&action=search',
            'add_button_classes' => '',
            'load_more_button_route' => 'manager',
            'source' => 'list',
        ];
        ...
        $page += [
            ...
            'add_modal_create_url' => url('manager/create'),
            'add_modal_action_url' => url('manager'),
        ...
        if ($section == 'team') {
            $page += [
                'meta_title' => __('lang.managers'),
                'heading' => __('lang.managers'),
            ];
