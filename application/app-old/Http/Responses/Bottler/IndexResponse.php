...
namespace App\Http\Responses\Bottler;
...
class IndexResponse implements Responsable {
    ...
    public function toResponse($request) {
        ...
        if (request('source') == 'ext' || request('action') == 'search' || request()->ajax()) {
            ...
            case 'load':
                $template = 'pages/bottlers/components/table/ajax';
            ...
            case 'search':
                $template = 'pages/bottlers/components/table/table';
            ...
            default:
                $template = 'pages/bottlers/tabswrapper';
            ...
            return view('pages/bottlers/wrapper', compact('page', 'users'))->render();
        }
