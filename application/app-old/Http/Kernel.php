...
class Kernel extends HttpKernel {
    ...
    protected $routeMiddleware = [
        ...
        //[growcrm] - [team]
        'bottlerMiddlewareIndex' => \App\Http\Middleware\Bottlers\Index::class,
        'bottlerMiddlewareCreate' => \App\Http\Middleware\Bottlers\Create::class,
        'bottlerMiddlewareEdit' => \App\Http\Middleware\Bottlers\Edit::class,
