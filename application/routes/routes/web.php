...
Route::group(['prefix' => 'user'], function () {
    ...
    Route::post("/updatecalanderview", "User@updateCalanderView")->middleware(['demoModeCheck']);
});
...
Route::group(['prefix' => 'projects'], function () {
    ...
    Route::get("/{project}/team", "Projects@team")->where('project', '[0-9]+');
    Route::post("/{project}/team", "Projects@updateDescription")->where('project', '[0-9]+');
    Route::get("/{project}/log", "Projects@activity_log")->where('project', '[0-9]+');
    Route::any("/cad", "Projects@cad_jobs");
    Route::any("/cad_history", "Projects@cad_jobs_history");
   
    Route::get("/{project}/cad-details", "Projects@cad_details")->where('project', '[0-9]+');
    Route::post("/{project}/cad-details", "Projects@updateDescription")->where('project', '[0-9]+');
    Route::any("/{project}/cad-info", "Projects@showCad")->where('project', '[0-9]+');
    ...
    Route::post("/{project}/change-cad-status", "Projects@changeCadStatusUpdate")->where('project', '[0-9]+');
...
Route::group(['prefix' => 'tasks'], function () {
    ...
    Route::any("/v/{task}/{filter_unassigned}/{slug}", "Tasks@index")->where('task', '[0-9]+');
    ...
    Route::any("/worklog/{filter_unassigned?}", "Tasks@indexUnAllocated");
    //card tabs
    ...
    Route::get("/content/{task}/show-attachments", "Tasks@showAttachments")->where('task', '[0-9]+');
    
    Route::any("/calander/show-calander", "Tasks@showMyCalander");    
...
Route::group(['prefix' => 'leads'], function () {
    ...
    Route::any("/lead_titles", "Leads@leadTitles");
    ...
    Route::get("/change-status-bulk", "Leads@changeStatusBulk");
    Route::post("/change-status-bulk", "Leads@changeStatusBulkUpdate");
    ...
    Route::post("/{lead}/attach-files/{is_po?}", "Leads@attachFiles")->where('lead', '[0-9]+');
    Route::delete("/delete-attachment/{uniqueid}", "Leads@deleteAttachment");
    Route::post("/move-attachment/{uniqueid}", "Leads@moveAttachment");
    ...
    Route::post("/{lead}/update-date-proposal", "Leads@updateDateProposal")->where('lead', '[0-9]+');
    // Route::post("/{lead}/update-date-sent-to-st", "Leads@updateDateSentToSt")->where('lead', '[0-9]+');
    // Route::post("/{lead}/update-date-form-completion", "Leads@updateDateFormCompletion")->where('lead', '[0-9]+');
    ...
    Route::post("/{lead}/update-address", "Leads@updateAddress")->where('lead', '[0-9]+');
    ...
    Route::post("/{lead}/convert-lead-project", "Leads@convertLeadProject")->where('lead', '[0-9]+');
    ...
    Route::post("/content/{lead}/update-lead", "Leads@update")->where('lead', '[0-9]+');
    //map
    Route::get("/content/{lead}/show-map", "Leads@showMap")->where('lead', '[0-9]+');
    ...
    Route::get("/content/{lead}/show-attachments", "Leads@showAttachments")->where('lead', '[0-9]+');
...
Route::group(['prefix' => 'files'], function () {
    ...
    Route::post("/{file}/rename", "Files@renameFile")->middleware(['demoModeCheck']);
        Route::post("/{file}/move", "Files@moveFile")->middleware(['demoModeCheck']);
});
Route::resource('files', 'Files');

//FILE GROUPS
Route::group(['prefix' => 'filegroups'], function () {
    Route::any("/search", "FileGroups@index");
    Route::post("/savefolder", "FileGroups@store");
    Route::post("/showlist", "FileGroups@showlist");
    Route::post("/updatefolders", "FileGroups@update");
    Route::post("/deletefolder", "FileGroups@delete");
    Route::post("/{group}/rename", "FileGroups@renameFile")->middleware(['demoModeCheck']);
});
Route::resource('filegroups', 'FileGroups');
...
Route::group(['prefix' => 'leaves'], function () {
    ...
    Route::get("/v/{leave}", "Leaves@show")->where('leave', '[0-9]+');
    Route::post("/delete", "Leaves@destroy")->middleware(['demoModeCheck']);
    // Route::post("/", "Leaves@destroy")->middleware(['demoModeCheck']);
});
Route::resource('leaves', 'Leaves' )->parameters([
    'leaves' => 'leave'
]);
