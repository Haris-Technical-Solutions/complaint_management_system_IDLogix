<div class="card count-{{ @count($files) }}" id="files-table-wrapper">
    ...
    <div class="card-body">
        <div class="table-responsive">
            @if (@count($files) > 0 || @count($lead_files) > 0)
            <table id="file-foo-addrow" class="table m-t-0 m-b-0 table-hover no-wrap contact-list" data-page-size="10">
                <thead>
                    <tr>
                        ...
                        @if($fileresource_type=='project')
                        <th class="files_col_file">{{ cleanLang(__('lang.project')) }} {{ cleanLang(__('lang.title')) }} </th>
                        @endif
                        ...
                        <th class="hidden files_col_visible_to_client"><a class="js-ajax-ux-request js-list-sorting"
            ...
            @endif @if (@count($files) == 0 && @count($lead_files) == 0)
            <!--nothing found-->
