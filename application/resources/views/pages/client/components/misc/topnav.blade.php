                ...
                <ul class="nav nav-tabs profile-tab" role="tablist">
                    ...
                    @endif
                    @if(config('system.settings_modules_contracts') == 'enabled')
                    <!--contracts-->
                    ...
                    || config('system.settings_modules_payments') == 'enabled'
                    || config('system.settings_modules_expanses') == 'enabled'
                    || config('system.settings_modules_invoices') == 'enabled'
                    || config('system.settings_modules_estimates') == 'enabled'
                    || config('system.settings_modules_timesheets') == 'enabled'
                    ...
                    <li class="nav-item dropdown {{ $page['tabmenu_financial'] ?? '' }}">
                        ...
                        <div class="dropdown-menu" x-placement="bottom-start" id="fx-client-misc-topnave-billing">
                            ...
                            <a class="dropdown-item js-dynamic-url  js-ajax-ux-request {{ $page['tabmenu_invoices'] ?? '' }}"
                                ...
                                @endif
                            @if(config('system.settings_modules_expanses') == 'enabled')
                            <!--[expenses]-->
                            <a class="dropdown-item js-dynamic-url  js-ajax-ux-request {{ $page['tabmenu_invoices'] ?? '' }}"
                                data-toggle="tab" data-loading-class="loading-tabs"
                                data-loading-target="embed-content-container"
                            ...
                            <a class="dropdown-item js-dynamic-url  js-ajax-ux-request {{ $page['tabmenu_invoices'] ?? '' }}"
                                ...
                                @endif
                            @if(config('system.settings_modules_timesheets') == 'enabled')
                            <!--[timesheets]-->
