<div class="row" id="js-projects-modal-add-edit" data-section="{{ $page['section'] }}"
    ...
    <div class="col-lg-12">
        ...
        <!--automation-->
        @if (config('mode.create') && config('system.settings2_projects_automation_default_status') == 'enabled')
            <div class="form-group form-group-checkbox row">
                <label class="col-10 col-form-label text-left">@lang('lang.automation') <span
                        class="align-middle text-info font-16" data-toggle="tooltip" title="@lang('lang.apply_default_automation_project')"
                ...
                <div class="col-2 text-right p-t-5">
                    <input type="checkbox" id="automation" name="automation" class="filled-in chk-col-light-blue"
                        {{ runtimePrechecked(config('system.settings2_projects_automation_default_status')) }}>
            ...
            @if (config('visibility.project_modal_assign_fields'))
                <div class="form-group row">
                    <label
                        ...
                        <a class="align-middle font-14 toggle-collapse" href="#project_manager_info"
                    ...
                    <div class="col-sm-12 col-lg-9">
                        <select name="manager" id="manager" class="select2-basic form-control form-control-sm"
                            ...
                            <!--users list-->
                            @foreach (config('system.team_members') as $user)
                            {{-- @foreach(App\Models\User::team_members() as $user) --}}
                          <option></option>
                          @if($user->role_id==17)
                    ...
                    <div class="highlighted-panel">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="collapse col-sm-12 m-t-15" id="project_estimated_hours_info">
                                <div class="alert alert-info">{{ cleanLang(__('lang.project_estimated_hours_info')) }}
                                </div>
                            </div>
                        </div>
                        <!--cost estimate-->
                        <div class="form-group row m-b-0">
                            ...
                            <div class="col-sm-12 col-lg-4">
                                <input type="number" class="form-control form-control-sm"
                                    id="project_billing_costs_estimate" name="project_billing_costs_estimate"
                                    placeholder="" value="{{ $project['project_billing_costs_estimate'] ?? '' }}">
                            </div>
                            <div class="collapse col-sm-12 m-t-15" id="project_cost_estimate_info">
                                <div class="alert alert-info">{{ cleanLang(__('lang.project_cost_estimate_info')) }}
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            @if (config('visibility.project_modal_project_permissions'))
                ...
                <div class="hidden highlighted-panel" id="edit_project_assigned_permissions">
                    <div class="form-group form-group-checkbox row m-b-0">
                        <label class="col-5 col-form-label text-left">{{ cleanLang(__('lang.task_collaboration')) }}
                ...
                <div id="edit_project_permissions_tasks" class="hidden highlighted-panel">
                    ...
                    <div><small class="text-bold">**
                            {{ cleanLang(__('lang.if_items_selected_then_viewing_perm')) }}</small>
                    </div>
                    <div class="line m-t-30"></div>
                </div>
                <!--/#CLIENT PERMISSIONS-->
