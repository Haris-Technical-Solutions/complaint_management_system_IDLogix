...
<tr id="project_{{ $project->project_id }}">
    ...
    <td class="projects_col_project">
        <a href="{{ _url('/projects/'.$project->project_id.'/tasks') }}">{{ str_limit($project->project_title ??'---', 20) }}<a />
            <!--automation-->
    ...
    <td class="projects_col_action actions_column">
        ...
        <span class="list-table-action dropdown font-size-inherit">
            ...
            @endif
            <!--view-->
            <a href="{{ _url('/projects/'.$project->project_id.'/tasks') }}" title="{{ cleanLang(__('lang.view')) }}"
