        ...
        <ul data-modular-id="project_tabs_menu" class="nav nav-tabs profile-tab project-top-nav list-pages-crumbs"
            ...
            <li class="nav-item">
                <a class="nav-link tabs-menu-item   js-dynamic-url js-ajax-ux-request" data-toggle="tab"
                    id="tabs-menu-cad-details" data-loading-class="loading-tabs"
                    data-loading-target="embed-content-container"
                    data-dynamic-url="{{ _url('/projects') }}/{{ $project->project_id }}/cad-details"
                    data-url="{{ _url('/projects') }}/{{ $project->project_id }}/cad-details"
                    href="#projects_ajaxtab" role="tab">CAD {{ cleanLang(__('lang.details')) }}</a>
            </li>
            <li class="nav-item hidden">
                <a class="nav-link tabs-menu-item   js-dynamic-url js-ajax-ux-request" data-toggle="tab"
                    ...
                    href="#projects_ajaxtab" role="tab">Job {{ cleanLang(__('lang.details')) }}</a>
            </li>
            <!--[tasks]-->
            ...
            <li class="nav-item ">
                <a class="nav-link  tabs-menu-item   js-dynamic-url js-ajax-ux-request {{ $page['tabmenu_discussions'] ?? '' }}"
                    ...
                    href="#projects_ajaxtab" role="tab">{{ cleanLang(__('lang.updates')) }}</a>
            </li>
            {{-- @endif --}}
             <li class="nav-item hidden">
                <a class="nav-link  tabs-menu-item   js-dynamic-url js-ajax-ux-request {{ $page['tabmenu_notes'] ?? '' }}"
                    id="tabs-menu-log" data-toggle="tab" data-loading-class="loading-tabs"
                    data-loading-target="embed-content-container"
                    ...
                    href="#projects_ajaxtab" role="tab">{{ cleanLang(__('lang.my_notes')) }}</a>
            </li>
            <li class="nav-item ">
                <a class="nav-link  tabs-menu-item   js-dynamic-url js-ajax-ux-request {{ $page['tabmenu_log'] ?? '' }}"
                    id="tabs-menu-log" data-toggle="tab" data-loading-class="loading-tabs"
                    data-loading-target="embed-content-container"
                    data-dynamic-url="{{ _url('/projects') }}/{{ $project->project_id }}/details"
                    data-url="{{ _url('/projects') }}/{{ $project->project_id }}/log?source=ext&logresource_type=project&logresource_id={{ $project->project_id }}"
                    href="#projects_ajaxtab" role="tab">{{ cleanLang(__('lang.log')) }}</a>
            </li>
            <!--billing-->
            @if((auth()->user()->is_team || auth()->user()->is_client_owner) 
            &&
            runtimeGroupMenuVibility([config('visibility.modules.invoices'),
            ...
            <li data-modular-id="project_tabs_menu_financial"
                class="nav-item dropdown {{ $page['tabmenu_more'] ?? '' }} hidden">
            ...
            <!--[MODULES]-->
            <li data-modular-id="project_tabs_menu_more" class="nav-item dropdown {{ $page['tabmenu_more'] ?? '' }} hidden">
