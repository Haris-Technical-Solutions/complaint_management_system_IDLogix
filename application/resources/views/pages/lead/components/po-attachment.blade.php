@foreach($po_attachments as $attachment)
    ...
    <div class="file-attachment">
        ...
        <div class="x-details">
            ...
            <div class="x-actions"><strong>
                    <!--action: download-->
                    <a href="leads/download-attachment/{{ $attachment->attachment_uniqiueid }}" download>{{ cleanLang(__('lang.download')) }}
                ...
                <span> |
                    <a href="javascript:void(0)" class="text-danger js-delete-ux-confirm confirm-action-danger"
                        ...
                        data-url="{{ url('/leads/delete-attachment/'.$attachment->attachment_uniqiueid) }}">{{ cleanLang(__('lang.delete')) }}</a></span>
                @endif
            </div>
        </div>
    </div>
