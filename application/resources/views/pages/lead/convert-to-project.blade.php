<div class="p-40">
    <h3>{{ cleanLang(__('lang.convert_to_job')) }}</h3>
    ...
    <div class="col-lg-12">
            ...
            <div class="client-selector-container" id="client-existing-container">
                <div class="form-group row">
                    ...
                    <div class="col-sm-12 col-lg-9">
                        ...
                        <!--select2 basic search-->
                         @if(@$lead->lead_converted_clientid>0)
                        <option value="{{$lead->lead_converted_clientid}}" selected>$lead->client->client_company_name</option>
                        @endif 
                        </select>
                    </div>
                </div>
        ...
        <!--PROJECT PROGRESS   Hidden by Sher Ali -->
        ...
        <!--PROJECT OPTIONS Hidden by Sher Ali-->
        <div class="spacer row hidden">
            <div class="col-sm-8">
        ...
        <!--CUSTOMER FIELDS [collapsed] Hidden by Sher Ali-->
