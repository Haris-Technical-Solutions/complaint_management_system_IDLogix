<div class="row">
        ...
        <div class=" row ">
            ...
            <div class="col-sm-12 col-lg-4">
                <div class="switch  text-right">
                    <label>
                        <input type="checkbox" checked name="show_more_settings_tasks" id="show_more_settings_tasks"
 ...
 <div class="line"></div>
     <!--description-->
        <div class="" id="task_description_section">
            <div class="form-group row">
                <div class="col-sm-12">
      ...
      {{--  <div class="form-group row">
        ...
        <div class="collapse hidden" id="assigning_client_info">
            <div class="alert alert-info">
        ...
        @endif
         <!--due date-->
            @if(config('visibility.tasks_standard_features'))
             <div class="form-group row">
                <label
                    class="col-sm-12 col-lg-3 text-left control-label col-form-label">{{ cleanLang(__('lang.start_date')) }}</label>
                <div class="col-sm-12 col-lg-9">
                    <input type="text" class="form-control form-control-sm pickadate" name="task_date_start"
                        autocomplete="off" placeholder="">
                    <input class="mysql-date" type="hidden" name="task_date_start" id="task_date_start">
                </div>
            </div>
            <div class="form-group row">
                <label
                    class="col-sm-12 col-lg-3 text-left control-label col-form-label">{{ cleanLang(__('lang.due_date')) }}</label>
                <div class="col-sm-12 col-lg-9">
        ...
        <div class="hidden" id="additional_information_section">
            ...
            <div class="toggle_task_type add_task_toggle_container_project hidden">
