...
return [
    ...
    'a_project_is_required_for_billable_expenses' => "A Machine is required (for billable expenses)",
    ...
    'active_projects' => "Active Machines",
    'active_tasks' => "Active Complaints",
    ...
    'add_client_manager' => "Add Location Manager",
    'add_client' => "Add Location",
    ...
    'all_leads' => "All leads",
    'all_projects' => "All Machines",
    'all_setting_permissions_when_adding_project' => "Allow user to set location and staff permissions when adding a new machine",
    'all_tasks' => "All Complaints",
    'all_tickets' => "All Tickets",
    'all_time' => "All Time",
    'all' => "All",
    'allow_customers_to_signup' => "Allow location to signup",
    ...
    'allow_project_managers_to_edit_milestone' => "Allows machine managers to change and edit machine milestones",
    ...
    'archive_project' => "Archive Machine",
    'archive_task' => "Archive Complaint",
    'archive' => "Archive",
    'archived' => "Archived",
    'archives_leads' => "Archived Leads",
    'archives_projects' => "Archived Machines",
    'archives_tasks' => "Archived Complaints",
    'archives' => "Archives",
    ...
    'assign_projects' => "Assign Machines",
    'assign_tasks' => "Assign Complaints",
    ...
    'attach_to_project' => "Attach To A Machine",
    'attach' => "Attach",
    'attachement' => "File Attachment",
    'attachments' => "File Attachments",
    'august_short' => "Aug",
    'august' => "August",
    'available_to_all_clients' => "Available to all locations",
    ...
    'billable_hours_info' => "These are all the hours that have not yet been invoiced for this machine",
    ...
    'client_already_exists' => "This location already exists",
    'client_email_required_for_dashboard_access' => "Location name & email address are required for a contact with dashboard access",
    'client_emails' => "Location Emails",
    'client_files' => "Location Files",
    'client_has_not_paid_for_subsccrition' => "Location has not yet paid for this subscription",
    'client_has_not_yet_accepted_the_contract' => "Location has not yet accepted the contract",
    'client_id' => "Location ID",
    'client_is_required' => "A location is required",
    'client_manager_information' => "A location manager will have full access to all the locations machines, billing etc",
    'client_manager' => "Location Manager",
    'client_name_is_required' => "Location name is required",
    'client_name' => "Location Name",
    'client_not_found' => "Location could not be found",
    'client_permissions' => "Location Permissions",
    'client_project_permissions' => "Location's Machine Permissions",
    'client_project' => "Location & Machine",
    'client_rejected_the_contract' => "Location rejected the contract",
    'client_signature' => "Location Signature",
    'client_users' => "Location Users",
    'client_visibility_invalid' => "Location visibility option is invalid",
    'client_visibility' => "Location Visibility",
    'client' => "Location",
    'clients' => "Locations",
    ...
    'completed_projects' => "Completed Machines",
    'completed_tasks' => "Completed Complaints",
    'completed' => "Completed",
    ...
    'convert_to_a_customer' => "Convert To A Location",
    'convert_to_customer' => "Convert To Location",
    ...
    'create_project_template' => "Create Machine Template",
    'create_subscription' => "Create A Subscription",
    'create_tasks' => "Create Complaints",
    ...
    'default' => "Default",
    'delete_all_tasks' => "Delete all complaints",
    'delete_article' => "Delete Article",
    'delete_canned_template' => "Delete Template",
    'delete_category' => "Delete Category",
    'delete_client_manager' => "Delete Location Manager",
    'delete_client' => "Delete Location",
    ...
    'design' => "Design",
    'detach_from_project' => "Detach From Machine",
    'details' => "Details",
    ...
    'display_name_info' => "Text displayed to the location (e.g. Credit Card, Bank Transfer)",
    ...
    'edit_project_template' => "Edit Machine Template",
    'edit_project' => "Edit Machine",
    'edit_proposal' => "Edit Proposal",
    'edit_settings' => "Edit Settings",
    'edit_tag' => "Edit Tag",
    'edit_task' => "Edit Complaint",
    ...
    'email_to_client' => "Email To Location",
    'email' => "Email",
    ...
    'event_assigned_user_to_a_project_alt' => 'Assigned a machine to',
    'event_assigned_user_to_a_project' => 'Assigned you to a machine',
    'event_assigned_user_to_a_task_alt' => 'Assigned a complaint to',
    'event_assigned_user_to_a_task' => 'Assigned you to a complaint',
    ...
    'event_changed_project_status' => "Changed machine status",
    'event_changed_status' => "Changed status",
    'event_changed_task_status_completed' => "Completed a complaint",
    'event_changed_task_status' => "Changed complaint status",
    ...
    'event_created_lead' => "Created a new complaint",
    'event_created_project' => "Created a new machine",
    'event_created_subscription' => "Created a new subscription",
    'event_created_task' => "Created a new complaint",
    ...
    'expense_has_already_been_invoiced' => "This expense has been invoiced. Location and machine can longer be changed",
    ...
    'filter_all_projects' => "Filter All Machines",
    'filter_clients' => "Filter Locations",
    ...
    'global' => "Global",
    'gross' => "Gross",
    'group_by_task' => "Group By Complaint",
    ...
    'if_you_do_not_delete_tasks' => "If you do not delete complaints, they will be moved into (uncategoried) milestones",
    ...
    'milestone_is_not_empty' => "Milestone has linked complaints. You must first move them",
    ...
    'move_down' => "Move Up",
    'move_tasks_to_another_milestone' => "Move complaints to another milestone",
    ...
    'new_project' => "New Machine",
    'new_status' => "New status",
    'new_task' => "New Complaint",
    ...
    'none' => "None",
    'normal' => "Normal",
    'not_attached_to_project' => "Not attached to a machine",
    'not_billable' => "Not Billable",
    'not_invoiced' => "Not Invoiced",
    'not_started' => "Not Started",
    'not_visible_to_the_client' => "not visible to the location",
    'not_visisble_to_client' => "Not visible to the location",
    ...
    'only_available_to_specified_customers' => "Only available to specified locations",
    'open_a_support_ticket' => "Open A Support Ticket",
    'open_projects' => "Open Machines",
    ...
    'pending_tasks' => "Pending Complaints",
    'pending' => "Pending",
    ...
    'profit' => "Profit",
    'progress' => "Progress",
    'project_billing_info' => "Machine Billing Info",
    'project_billing' => "Machine Billing",
    'project_cost_estimate_info' => "Your projected expenses on this machine. This information is not visible to the location. You can also leave it blank.",
    'project_estimated_hours_info' => "The amount of time you expect to send on this machine. Adding this information,will help you keep track of your time budget.",
    'project_files' => "Machine Files",
    'project_id' => "Machine ID",
    'project_is_required' => "A machine is required",
    'project_manager_info' => "A machine manager will have admin level permissions to manage all aspects of this machine",
    'project_manager' => "Machine Manager",
    'project_not_found' => "Machine could not be found",
    'project_notes_not_visible_to_client' => "Machine notes are not visible to the location",
    'project_progress' => "Machine Progress",
    'project_proposal' => "Machine Proposal",
    'project_settings' => "Machine Settings",
    'project_template' => "Machine Template",
    'project_title' => "Machine Title",
    'project' => "Machine",
    'projects' => "Machines",
    ...
    'restore_project' => "Restore Machine",
    'restore_task' => "Restore Complaint",
    'restore' => "Restore",
    'revised' => "Revised",
    'right' => "Right",
    ...
    'send_email_to_client' => "Send an email to the location",
    ...
    'set_progress_manually' => "Set Progress Manually",
    'set_project_permissions' => "Set Machine Permissions",
    ...
    'show_archive_projects' => "Show Archived Machines",
    'show_archive_tasks' => "Show Archived Complaints",
    ...
    'show_permission_project_creation' => "Show permissions settings during machine creation",
    'show_profile' => "Show on location profile",
    'show_project_after_its_created' => "Show machine after its been created",
    'show_project' => "Show on machine profile",
    'show_task_after_adding' => "Show complaint after adding",
    'show_task' => "Show on complaint summary",
    'show' => "Show",
    ...
    'starred_projects' => "Starred machines",
    'starred_tasks' => "Starred Complaints",
    ...
    'subscription_log_cancelled_client' => "Subscription was cancelled by the location",
    ...
    'task_based_progress' => "Complaints Based Progress",
    'task_collaboration_info' => "Assigned users will be able to view and participate (comment, attach files, etc) in other users complaints",
    'task_collaboration' => "Complaint Collaboration",
    'task_id' => "Complaint ID",
    'task_not_found' => "Complaint could not be found",
    'task_participation' => "Complaints Participation",
    'task_priority' => "Complaint Priority",
    'task_settings' => "Complaint Settings",
    'task' => "Complaint",
    'tasks_collaboration' => "Complaints Colloboration",
    'tasks' => "Complaints",
    ...
    'template_lang_new_project_created' => "New Machine Created",
    ...
    'template_lang_project_assignment' => "Machine Assignment",
    'template_lang_project_comment' => "Machine Comment",
    'template_lang_project_file_uploaded' => "Machine File Uploaded",
    'template_lang_project_status_change' => "Machine Status Change",
    ...
    'template_lang_task_assignment' => "Complaint Assignment",
    'template_lang_task_comment' => "Complaint Comment",
    'template_lang_task_file_uploaded' => "Complaint File Uploaded",
    'template_lang_task_status_change' => "Complaint Status Change",
    ...
    'text' => "Text",
    'thank_you' => "Thank You",
    'the_estimate_will_be_marked_as_revised' => "The estimate will be marked as (Revised) and an email will be sent to the location",
    'the_estimate_will_be_sent_to_customer' => "The estimate will be emailed to the location",
    'the_following_fields_do_not_have_a_name' => "The following are enabled but do not have a name",
    'the_invoice_will_be_sent_to_customer' => "The invoice will be emailed to the location",
    'theme' => "Theme",
    ...
    'this_project_is_archived' => "This machine is archived",
    'this_task_is_archived' => "This complaint is archived",
    'this_week' => "This Week",
    'this_year' => "This Year",
    ...
    'visible_to_client' => "Visible To Location",
    ...
    'weekly' => "Weekly",
    'weeks' => "Weeks",
    'welcome_to_dashboard' => "Welcome to your new machine dashboard",
    'welcome' => "Welcome",
    'year_years' => "Year(s)",
    'year' => "Year",
    'yearly' => "Yearly",
    ...
    'you_created_this_project' => "You created this machine",
    'you_created_this_proposal' => "You created this proposal",
    'you_created_this_task' => "You created this complaint",
    ...
    'add_project_splah_title' => "Who is this machine for?",
    'allow_clients_to_login' => "Allow locations to login",
    ...
    'client_has_not_opened' => "location has not opened",
    'client_has_opened' => "location has opened",
    'clients_disabled_login_error' => "Access denied. Please contact location support for assistance",
    ...
    'disable_all_client_emails' => "Disable all location emails",
    'disable_client_emails_notes' => "The system will not send any emails to location users",
    ...
    'import_leads' => "Import Leads",
    'import_projects' => "Import Machines",
    'import_tasks' => "Import Complaints",
    'import_tasks' => "Import Complaints",
    ...
    'no_tasks_assigned_to_you' => "There are no complaints assigned to you on the selected machine",
    'no_tasks_found' => "No complaints found",
    ...
    'show_if_client_has_opened' => "Show if it has been viewed by the location",
    'start_timer' => "Start Timer",
    'task_could_not_be_found' => "Complaint could not be found",
    ...
    'you_are_now_not_assigned_to_this_project' => "You are not assigned to this machine",
    'you_are_now_not_assigned_to_this_task' => "You are not assigned to this complaint",
    ...
    'copy_task_checklist' => "Copy Complaint Checklist",
    'copy_task_file' => "Copy Complaint Files",
    'copy_these_items' => "Copy These Items",
    'create_a_new_project' => "Create a new projecct",
    'create_a_project_template' => "Create A Machine Template",
    ...
    'is_required' => "is required",
    'project_templates' => "Machine Templates",
    'project_teplate' => "Machine Template",
    'remove_adjustment' => "Remove Adjustment",
    'select_a_template' => "Select A Template",
    'show_template_after_its_created' => "Show template after it has been created",
    'templates' => "Templates",
    'this_is_total_logged_time_task' => "This is the total time you have loggged for this complaint. For individual time record, see your timesheets",
    ...
    'client_reminder' => "Location Reminder",
    ...
    'lead_reminder' => "Lead Reminder",
    'linked_to_projects' => "Requires the machines module",
    'linked_to_tasks' => "Requires the complaints module",
    ...
    'project_reminder' => "Machine Reminder",
    ...
    'selected' => "Selected",
    'send_customer_payment_email' => "Send the location a payment received email",
    ...
    'task_reminder' => "Complaint Reminder",
    'template_lang_reminder' => "Reminder",
    'template_lang_task_overdue' => "Complaint Overdue",
    ...
    'add_new_task_status' => "Add New Complaint Status",
    'clone_lead' => "Clone Lead",
    'clone_task' => "Clone Complaint",
    'copy_checklists' => "Copy Checklists",
    'copy_files' => "Copy Files",
    'delete_task_status' => "Delete Complaint Status",
    ...
    'invalid_permissions_for_project' => "You do not have permissions for this machine",
    ...
    'task_status_not_empty' => "This status is not empty. First move its complaints to another status",
    ...
    'update_progress_info' => "If you do not set the progress manually, it will be set automatically, based on the number of completed complaints",
    ...
    'category_team_info' => "If you are using category based permissions, the users selected here will have access to all the machines that are in this category.",
    'category_users' => "Category Team Members",
    'change_cover_image' => "Change Cover Image",
    'change_theme' => "Change Theme",
    'changing_project_permissions_warning' => "Changing the (Machine Team Permissions) setting will cause all machines to be reassigned according to the new setting. As such, this setting should not be changed frequently.",
    ...
    'project_cover_images_feature' => "Machine Cover Images",
    'projects_assigned_auto' => "Users are assigned automatically from the machine's category users",
    'projects_user_permission' => "Machine Team Permissions",
    'queue_all_email_again' => "Queue All Email Again",
    'recommended_image_size' => "Recommended Image Size",
    'recurring_task' => "Recurring Complaint",
    'role_based' => "User Role Based",
    'run_test_now' => "Run Test Now",
    'show_project_categories_main_menu' => "Show Machine Categories In Main Menu",
    ...
    'task_is_not_recurring' => "Complaint in not recurring",
    'task_recurring_cycles_explanation' => "This is the date when the next recurring complaint will be created. Once set, the future dates will be automatically calculated.",
    'task_recurring_period_info' => "The complaint will stop recurring after these number of cycles. For infinity, set the value to 0",
    ...
    'assign_client' => "Assign Location",
    'assign_client_info' => "Use this option to assign this complaint to the location",
    'change_header_image' => "Change Header Image (optional)",
    'client_or_lead_required' => "A location or a lead is required",
    ...
    'documeny_publish_confirm' => "The document will be emailed to the location",
    ...
    'admin' => "Admin",
    'all_task_users' => "All Complaint Users",
    ...
    'apply_default_automation_project' => "Apply default automation settings. These can be changed, once the machine has been created",
    'automation' => "Automation",
    'automation' => "Automation",
    'automation_assign_project' => "Automatically assign the machine",
    'automation_create_invoice' => "Create a new invoice",
    'automation_create_project' => "Create a new machine",
    'automation_create_project_status' => "Machine status",
    'automation_create_tasks_from_line_item' => "Create a complaint for each line item",
    'automation_create_tasks_from_line_item' => "Create a complaint for each line item",
    'automation_email_client' => "Email to the location",
    'automation_email_client_invoice_info' => "Send a 'New Invoice Created' email",
    'automation_email_client_project_info' => "Send a 'New Machine Created' email",
    'automation_email_invoices_to_client' => "Email invoices to the location",
    ...
    'automation_generate_invoice_info' => "Invoices will be generated from existing estimates for this machine",
    'automation_invoice_due_date' => "Invoice due date (days)",
    'automation_invoice_project' => "Automatically create invoices for the machine",
    ...
    'blocking_task' => "Blocking Complaint",
    'default_tax' => "Default Tax",
    'dependecies_have_been_fulfilled' => "Complaint dependencies have been fulfilled",
    'dependencies' => "Dependencies",
    'dependency_has_been_fulfilled' => "Dependency has been fulfilled",
    'dependency_prevents_task_from_completing' => "Prevents this complaint from being completed",
    'dependency_prevents_task_from_starting' => "Prevents this complaint from being started",
    ...
    'manage_task_dependencies' => "Manage Complaint Dependencies",
    'no_automation_options_selected' => "No automation options have been selected",
    'project_automation' => "Machine Automation",
    'project_automation_default' => "Machine Automation (default status)",
    'project_automation_default_info' => "If enabled, this automation will be available when creating a new machine",
    'project_automation_info_1' => "When a machine is marked as 'completed', do the following",
    'project_automation_info_3' => "These are the default settings, but you can still change them on a machine by machine basis",
    'remove_dependency' => "Remove Dependency",
    'select_atleast_one_invoice_creation_option' => "Selected at least (one) invoice creation option",
    'task_blocking_info_1' => "This is the restriction that will be applied to this complaint. Either the complaint can not be started, or it cannot be marked as competed",
    'task_blocking_info_2' => "This is the complaint which, until it has been marked as complete, will cause a restriction on this complaint",
    'task_dependency_already_exists' => "This complaint dependancy already exists",
    'task_dependency_info_cannot_be_completed' => "This complaint is locked (cannot be marked as completed)",
    'task_dependency_info_cannot_be_started' => "This complaint is locked (cannot be started)",
    'tasks_dependencies' => "Complaint Dependencies",
    'folders' => "Folders",
    'folder' => "Folder",
    ...
    'client_company_name' => "Location Company Name",
    'client_email' => "Location Email",
    'standard_fields' => "Standard Fields",
    'not_checked_custom_fields' => "Not Selected",
    'created_by_name' => "Creator Name",
    'created_by_email' => "Creator Email",
    'export_clients' => "Export Locations",
    'standard_fields' => "Standard Fields",
    'not_checked_custom_fields' => "Not Selected",
    'select_table_columns' => "Select table columbs",
    ...
    'you_earned' => "You earned", //context 'You earned $10 from machine ABC with invoice ID: #100'
    'from_project' => "from machine", //context - see above
    'with_invoice_id' => "with invoice ID", //context - see above
    'profit' => "Profit",
    'add_affiliate_project' => "Add Affiliate Machine",
    'edit_affiliate_project' => "Edit Affiliate Machine",
    'edit_affiliate_user' => "Add Affiliate User",
    'affiliate' => "Affiliate",
    'project_automation_info_2' => "This applies to machines that are manually marked as completed",
    'skip_estimates_with_draft_status' => "Skip draft estimates",
    'skip_estimates_with_declined_status' => "Skip declined estimates",
    'this_task' => "This complaint",
    'roles' => "Roles",
    'home_page' => "Home Page",
    'edit_home_page_setting' => "Edit home page settings",
    'could_not_be_found' => "Could not be found",
    'blocking_task_is_already_completed' => "Blocking complaint is aleady in completed status",
    ...
    'product_tasks' => "Product Complaints",
    ...
    'copy_to' => "Copy To",
    'copy_from' => "Copy From",
    'product_tasks_info' => "[optional] These are the machine complaints that are created for this product (line item), when estimate automation is run",
    'estimate_notes_info' => "These notes will be displayed when editing an estimate or invoice. These notes are not visible to the location",
    ...
    'move_tasks' => "Move Complaints",
    'move_leads' => "Move Leads",
    'move_tickets' => "Move Tickets",
    'tickets_apply_when_customer_replied' => "Apply this status when a location has replied to a ticket",
    ...
    'contract_signature_cannot_be_delete' => "Signature can nolonger be delete because the location has already signed the contract",
    ...
    'task_action_permission_error' => "You current permission levels do not permit this action on this particular complaint",

    //--------------V2.1 Language Changes-------------------
    'foo' => "bar",
    'foo' => "bar",
    'foo' => "bar",
    'foo' => "bar",
